...
def main():
    ...
    parser.add_argument(
        "-r", "--prc", action="store_true", help="Calculate PRC (Precision and Recall)"
    )
    parser.add_argument(
        "-p",
        "--ppl",
    ...
    parser.add_argument(
        "--prc-neighborhood",
        default=DEFAULTS["prc_neighborhood"],
        type=int,
        help="Number of nearest neighbours in PRC",
    )
    parser.add_argument(
        "--prc-batch-size",
        default=DEFAULTS["prc_batch_size"],
        type=int,
